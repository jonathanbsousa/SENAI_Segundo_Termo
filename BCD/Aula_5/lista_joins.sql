...
SELECT emprestimo.id_emprestimo, leitores.nome_leitor, livros.titulo FROM emprestimos_leitores
INNER JOIN leitores ON emprestimos_leitores.id_emprestimo = leitores.nome_leitor
