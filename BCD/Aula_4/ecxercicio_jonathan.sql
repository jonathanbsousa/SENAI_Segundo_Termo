...
SELECT livro.titulo, autor.nome, categoria.nome, status.nome, usuario.nome, emprestimo.data_emprestimo, emprestimo.data_devolucao FROM livro
...
INNER JOIN emprestimo ON emprestimo.id = emprestimo.usuario_id
