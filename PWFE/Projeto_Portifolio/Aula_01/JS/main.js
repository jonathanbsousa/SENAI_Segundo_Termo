...
document.addEventListener("DOMContentLoaded", function () {
    const response = document.querySelector(".activity_container")

    response.addEventListener("click", function() {
        window.location.href = "https://www.figma.com/design/ZpJra0I6FMB9gSUoleVCb7/Untitled?m=auto&t=eOJNqrop4miV764d-6"
    })
})